...
var file_data_coord_proto_rawDesc = []byte{
	...
	0x09, 0x73, 0x74, 0x61, 0x74, 0x69, 0x73, 0x74, 0x69, 0x63, 0x10, 0x0a, 0x32, 0xcf, 0x29, 0x0a,
	0x09, 0x44, 0x61, 0x74, 0x61, 0x43, 0x6f, 0x6f, 0x72, 0x64, 0x12, 0x6c, 0x0a, 0x12, 0x47, 0x65,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x4c, 0x0a, 0x05, 0x46, 0x6c,
...
var file_data_coord_proto_depIdxs = []int32{
	...
	117, // 165: milvus.proto.data.QueryImportResponse.status:type_name -> milvus.proto.common.Status
	4,   // 166: milvus.proto.data.QueryImportResponse.state:type_name -> milvus.proto.data.ImportTaskStateV2
	95,  // 167: milvus.proto.data.QueryImportResponse.import_segments_info:type_name -> milvus.proto.data.ImportSegmentInfo
	122, // 168: milvus.proto.data.ImportJob.schema:type_name -> milvus.proto.schema.CollectionSchema
	127, // 169: milvus.proto.data.ImportJob.state:type_name -> milvus.proto.internal.ImportJobState
	126, // 170: milvus.proto.data.ImportJob.files:type_name -> milvus.proto.internal.ImportFile
	121, // 171: milvus.proto.data.ImportJob.options:type_name -> milvus.proto.common.KeyValuePair
	4,   // 172: milvus.proto.data.PreImportTask.state:type_name -> milvus.proto.data.ImportTaskStateV2
	92,  // 173: milvus.proto.data.PreImportTask.file_stats:type_name -> milvus.proto.data.ImportFileStats
	4,   // 174: milvus.proto.data.ImportTaskV2.state:type_name -> milvus.proto.data.ImportTaskStateV2
	92,  // 175: milvus.proto.data.ImportTaskV2.file_stats:type_name -> milvus.proto.data.ImportFileStats
	5,   // 176: milvus.proto.data.ImportTaskV2.source:type_name -> milvus.proto.data.ImportTaskSourceV2
	116, // 177: milvus.proto.data.GcControlRequest.base:type_name -> milvus.proto.common.MsgBase
	6,   // 178: milvus.proto.data.GcControlRequest.command:type_name -> milvus.proto.data.GcCommand
	121, // 179: milvus.proto.data.GcControlRequest.params:type_name -> milvus.proto.common.KeyValuePair
	117, // 180: milvus.proto.data.QuerySlotResponse.status:type_name -> milvus.proto.common.Status
	3,   // 181: milvus.proto.data.CompactionTask.type:type_name -> milvus.proto.data.CompactionType
	7,   // 182: milvus.proto.data.CompactionTask.state:type_name -> milvus.proto.data.CompactionTaskState
	119, // 183: milvus.proto.data.CompactionTask.pos:type_name -> milvus.proto.msg.MsgPosition
	122, // 184: milvus.proto.data.CompactionTask.schema:type_name -> milvus.proto.schema.CollectionSchema
	128, // 185: milvus.proto.data.CompactionTask.clustering_key_field:type_name -> milvus.proto.schema.FieldSchema
	87,  // 186: milvus.proto.data.CompactionTask.pre_allocated_segmentIDs:type_name -> milvus.proto.data.IDRange
	119, // 187: milvus.proto.data.FlushResponse.ChannelCpsEntry.value:type_name -> milvus.proto.msg.MsgPosition
	119, // 188: milvus.proto.data.GetSegmentInfoResponse.ChannelCheckpointEntry.value:type_name -> milvus.proto.msg.MsgPosition
	43,  // 189: milvus.proto.data.SegmentInfo.TextStatsLogsEntry.value:type_name -> milvus.proto.data.TextIndexStats
	43,  // 190: milvus.proto.data.SegmentBinlogs.TextStatsLogsEntry.value:type_name -> milvus.proto.data.TextIndexStats
	58,  // 191: milvus.proto.data.SyncSegmentsRequest.SegmentInfosEntry.value:type_name -> milvus.proto.data.SyncSegmentInfo
	91,  // 192: milvus.proto.data.ImportFileStats.HashedStatsEntry.value:type_name -> milvus.proto.data.PartitionImportStats
	129, // 193: milvus.proto.data.DataCoord.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	130, // 194: milvus.proto.data.DataCoord.GetTimeTickChannel:input_type -> milvus.proto.internal.GetTimeTickChannelRequest
	131, // 195: milvus.proto.data.DataCoord.GetStatisticsChannel:input_type -> milvus.proto.internal.GetStatisticsChannelRequest
	...
	132, // 211: milvus.proto.data.DataCoord.GetFlushAllState:input_type -> milvus.proto.milvus.GetFlushAllStateRequest
	133, // 212: milvus.proto.data.DataCoord.ShowConfigurations:input_type -> milvus.proto.internal.ShowConfigurationsRequest
	134, // 213: milvus.proto.data.DataCoord.GetMetrics:input_type -> milvus.proto.milvus.GetMetricsRequest
	135, // 214: milvus.proto.data.DataCoord.ManualCompaction:input_type -> milvus.proto.milvus.ManualCompactionRequest
	136, // 215: milvus.proto.data.DataCoord.GetCompactionState:input_type -> milvus.proto.milvus.GetCompactionStateRequest
	137, // 216: milvus.proto.data.DataCoord.GetCompactionStateWithPlans:input_type -> milvus.proto.milvus.GetCompactionPlansRequest
	...
	138, // 225: milvus.proto.data.DataCoord.CheckHealth:input_type -> milvus.proto.milvus.CheckHealthRequest
	139, // 226: milvus.proto.data.DataCoord.CreateIndex:input_type -> milvus.proto.index.CreateIndexRequest
	140, // 227: milvus.proto.data.DataCoord.AlterIndex:input_type -> milvus.proto.index.AlterIndexRequest
	141, // 228: milvus.proto.data.DataCoord.GetIndexState:input_type -> milvus.proto.index.GetIndexStateRequest
	142, // 229: milvus.proto.data.DataCoord.GetSegmentIndexState:input_type -> milvus.proto.index.GetSegmentIndexStateRequest
	143, // 230: milvus.proto.data.DataCoord.GetIndexInfos:input_type -> milvus.proto.index.GetIndexInfoRequest
	144, // 231: milvus.proto.data.DataCoord.DropIndex:input_type -> milvus.proto.index.DropIndexRequest
	145, // 232: milvus.proto.data.DataCoord.DescribeIndex:input_type -> milvus.proto.index.DescribeIndexRequest
	146, // 233: milvus.proto.data.DataCoord.GetIndexStatistics:input_type -> milvus.proto.index.GetIndexStatisticsRequest
	147, // 234: milvus.proto.data.DataCoord.GetIndexBuildProgress:input_type -> milvus.proto.index.GetIndexBuildProgressRequest
	148, // 235: milvus.proto.data.DataCoord.ListIndexes:input_type -> milvus.proto.index.ListIndexesRequest
	...
	149, // 239: milvus.proto.data.DataCoord.ImportV2:input_type -> milvus.proto.internal.ImportRequestInternal
	150, // 240: milvus.proto.data.DataCoord.GetImportProgress:input_type -> milvus.proto.internal.GetImportProgressRequest
	151, // 241: milvus.proto.data.DataCoord.ListImports:input_type -> milvus.proto.internal.ListImportsRequestInternal
	129, // 242: milvus.proto.data.DataNode.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	131, // 243: milvus.proto.data.DataNode.GetStatisticsChannel:input_type -> milvus.proto.internal.GetStatisticsChannelRequest
	...
	133, // 246: milvus.proto.data.DataNode.ShowConfigurations:input_type -> milvus.proto.internal.ShowConfigurationsRequest
	134, // 247: milvus.proto.data.DataNode.GetMetrics:input_type -> milvus.proto.milvus.GetMetricsRequest
	...
	152, // 262: milvus.proto.data.DataCoord.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
	153, // 263: milvus.proto.data.DataCoord.GetTimeTickChannel:output_type -> milvus.proto.milvus.StringResponse
	153, // 264: milvus.proto.data.DataCoord.GetStatisticsChannel:output_type -> milvus.proto.milvus.StringResponse
	10,  // 265: milvus.proto.data.DataCoord.Flush:output_type -> milvus.proto.data.FlushResponse
	14,  // 266: milvus.proto.data.DataCoord.AllocSegment:output_type -> milvus.proto.data.AllocSegmentResponse
	17,  // 267: milvus.proto.data.DataCoord.AssignSegmentID:output_type -> milvus.proto.data.AssignSegmentIDResponse
	22,  // 268: milvus.proto.data.DataCoord.GetSegmentInfo:output_type -> milvus.proto.data.GetSegmentInfoResponse
	20,  // 269: milvus.proto.data.DataCoord.GetSegmentStates:output_type -> milvus.proto.data.GetSegmentStatesResponse
	24,  // 270: milvus.proto.data.DataCoord.GetInsertBinlogPaths:output_type -> milvus.proto.data.GetInsertBinlogPathsResponse
	26,  // 271: milvus.proto.data.DataCoord.GetCollectionStatistics:output_type -> milvus.proto.data.GetCollectionStatisticsResponse
	28,  // 272: milvus.proto.data.DataCoord.GetPartitionStatistics:output_type -> milvus.proto.data.GetPartitionStatisticsResponse
	153, // 273: milvus.proto.data.DataCoord.GetSegmentInfoChannel:output_type -> milvus.proto.milvus.StringResponse
	117, // 274: milvus.proto.data.DataCoord.SaveBinlogPaths:output_type -> milvus.proto.common.Status
	45,  // 275: milvus.proto.data.DataCoord.GetRecoveryInfo:output_type -> milvus.proto.data.GetRecoveryInfoResponse
	47,  // 276: milvus.proto.data.DataCoord.GetRecoveryInfoV2:output_type -> milvus.proto.data.GetRecoveryInfoResponseV2
	50,  // 277: milvus.proto.data.DataCoord.GetChannelRecoveryInfo:output_type -> milvus.proto.data.GetChannelRecoveryInfoResponse
	54,  // 278: milvus.proto.data.DataCoord.GetFlushedSegments:output_type -> milvus.proto.data.GetFlushedSegmentsResponse
	52,  // 279: milvus.proto.data.DataCoord.GetSegmentsByStates:output_type -> milvus.proto.data.GetSegmentsByStatesResponse
	154, // 280: milvus.proto.data.DataCoord.GetFlushAllState:output_type -> milvus.proto.milvus.GetFlushAllStateResponse
	155, // 281: milvus.proto.data.DataCoord.ShowConfigurations:output_type -> milvus.proto.internal.ShowConfigurationsResponse
	156, // 282: milvus.proto.data.DataCoord.GetMetrics:output_type -> milvus.proto.milvus.GetMetricsResponse
	157, // 283: milvus.proto.data.DataCoord.ManualCompaction:output_type -> milvus.proto.milvus.ManualCompactionResponse
	158, // 284: milvus.proto.data.DataCoord.GetCompactionState:output_type -> milvus.proto.milvus.GetCompactionStateResponse
	159, // 285: milvus.proto.data.DataCoord.GetCompactionStateWithPlans:output_type -> milvus.proto.milvus.GetCompactionPlansResponse
	67,  // 286: milvus.proto.data.DataCoord.WatchChannels:output_type -> milvus.proto.data.WatchChannelsResponse
	160, // 287: milvus.proto.data.DataCoord.GetFlushState:output_type -> milvus.proto.milvus.GetFlushStateResponse
	72,  // 288: milvus.proto.data.DataCoord.DropVirtualChannel:output_type -> milvus.proto.data.DropVirtualChannelResponse
	69,  // 289: milvus.proto.data.DataCoord.SetSegmentState:output_type -> milvus.proto.data.SetSegmentStateResponse
	117, // 290: milvus.proto.data.DataCoord.UpdateSegmentStatistics:output_type -> milvus.proto.common.Status
	117, // 291: milvus.proto.data.DataCoord.UpdateChannelCheckpoint:output_type -> milvus.proto.common.Status
	117, // 292: milvus.proto.data.DataCoord.MarkSegmentsDropped:output_type -> milvus.proto.common.Status
	117, // 293: milvus.proto.data.DataCoord.BroadcastAlteredCollection:output_type -> milvus.proto.common.Status
	161, // 294: milvus.proto.data.DataCoord.CheckHealth:output_type -> milvus.proto.milvus.CheckHealthResponse
	117, // 295: milvus.proto.data.DataCoord.CreateIndex:output_type -> milvus.proto.common.Status
	117, // 296: milvus.proto.data.DataCoord.AlterIndex:output_type -> milvus.proto.common.Status
	162, // 297: milvus.proto.data.DataCoord.GetIndexState:output_type -> milvus.proto.index.GetIndexStateResponse
	163, // 298: milvus.proto.data.DataCoord.GetSegmentIndexState:output_type -> milvus.proto.index.GetSegmentIndexStateResponse
	164, // 299: milvus.proto.data.DataCoord.GetIndexInfos:output_type -> milvus.proto.index.GetIndexInfoResponse
	117, // 300: milvus.proto.data.DataCoord.DropIndex:output_type -> milvus.proto.common.Status
	165, // 301: milvus.proto.data.DataCoord.DescribeIndex:output_type -> milvus.proto.index.DescribeIndexResponse
	166, // 302: milvus.proto.data.DataCoord.GetIndexStatistics:output_type -> milvus.proto.index.GetIndexStatisticsResponse
	167, // 303: milvus.proto.data.DataCoord.GetIndexBuildProgress:output_type -> milvus.proto.index.GetIndexBuildProgressResponse
	168, // 304: milvus.proto.data.DataCoord.ListIndexes:output_type -> milvus.proto.index.ListIndexesResponse
	81,  // 305: milvus.proto.data.DataCoord.GcConfirm:output_type -> milvus.proto.data.GcConfirmResponse
	117, // 306: milvus.proto.data.DataCoord.ReportDataNodeTtMsgs:output_type -> milvus.proto.common.Status
	117, // 307: milvus.proto.data.DataCoord.GcControl:output_type -> milvus.proto.common.Status
	169, // 308: milvus.proto.data.DataCoord.ImportV2:output_type -> milvus.proto.internal.ImportResponse
	170, // 309: milvus.proto.data.DataCoord.GetImportProgress:output_type -> milvus.proto.internal.GetImportProgressResponse
	171, // 310: milvus.proto.data.DataCoord.ListImports:output_type -> milvus.proto.internal.ListImportsResponse
	152, // 311: milvus.proto.data.DataNode.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
	153, // 312: milvus.proto.data.DataNode.GetStatisticsChannel:output_type -> milvus.proto.milvus.StringResponse
	117, // 313: milvus.proto.data.DataNode.WatchDmChannels:output_type -> milvus.proto.common.Status
	117, // 314: milvus.proto.data.DataNode.FlushSegments:output_type -> milvus.proto.common.Status
	155, // 315: milvus.proto.data.DataNode.ShowConfigurations:output_type -> milvus.proto.internal.ShowConfigurationsResponse
	156, // 316: milvus.proto.data.DataNode.GetMetrics:output_type -> milvus.proto.milvus.GetMetricsResponse
	117, // 317: milvus.proto.data.DataNode.CompactionV2:output_type -> milvus.proto.common.Status
	64,  // 318: milvus.proto.data.DataNode.GetCompactionState:output_type -> milvus.proto.data.CompactionStateResponse
	117, // 319: milvus.proto.data.DataNode.SyncSegments:output_type -> milvus.proto.common.Status
	76,  // 320: milvus.proto.data.DataNode.ResendSegmentStats:output_type -> milvus.proto.data.ResendSegmentStatsResponse
	117, // 321: milvus.proto.data.DataNode.FlushChannels:output_type -> milvus.proto.common.Status
	117, // 322: milvus.proto.data.DataNode.NotifyChannelOperation:output_type -> milvus.proto.common.Status
	85,  // 323: milvus.proto.data.DataNode.CheckChannelOperationProgress:output_type -> milvus.proto.data.ChannelOperationProgressResponse
	117, // 324: milvus.proto.data.DataNode.PreImport:output_type -> milvus.proto.common.Status
	117, // 325: milvus.proto.data.DataNode.ImportV2:output_type -> milvus.proto.common.Status
	93,  // 326: milvus.proto.data.DataNode.QueryPreImport:output_type -> milvus.proto.data.QueryPreImportResponse
	96,  // 327: milvus.proto.data.DataNode.QueryImport:output_type -> milvus.proto.data.QueryImportResponse
	117, // 328: milvus.proto.data.DataNode.DropImport:output_type -> milvus.proto.common.Status
	103, // 329: milvus.proto.data.DataNode.QuerySlot:output_type -> milvus.proto.data.QuerySlotResponse
	117, // 330: milvus.proto.data.DataNode.DropCompactionPlan:output_type -> milvus.proto.common.Status
